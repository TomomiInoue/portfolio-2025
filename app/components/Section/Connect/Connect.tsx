      ...
      <div className="container grid grid-cols-1 lg:grid-cols-5 gap-10">
        <div className="col-span-2 flex flex-col justify-center items-start">
          ...
          <p className="text-body04 lg:text-body03 text-secondary font-heebo mb-6">
            ...
            create. Whether you&apos;re a brand looking to elevate your digital
            presence or a fellow creative looking to team up, I&apos;d love to
            hear from you.
          </p>
          <Link
            href="mailto:tomomi.codes@gmail.com"
            passHref
            target="_blank"
          ...
          <div className="flex gap-4 mt-4">
            <Link
              href="https://www.linkedin.com/in/tomomi-inoue-730ab71ab/"
              target="_blank"
            >
              <Icon
